    ...
    <div class="container mx-auto max-w-lg mt-10 p-6 bg-white shadow-md rounded-lg">
        ...
        <form action="{{ route('song.update', $song->id) }}" method="POST" class="space-y-4">
            ...
            <div class="form-group">
                ...
                <input value="{{ $song->genre }}" type="text" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" id="artist" name="artist" required>
            </div>
            <div class="form-group">
